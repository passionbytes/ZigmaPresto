...
import com.passion.environment.ctrl.CommandEditor;
import com.passion.environment.ctrl.editor.DialogCommand;
import com.passion.environment.ctrl.editor.DialogFindReplace;
			...
			try {
				...
				if (!Preferences.getBoolean("querybuilder.use-schema")) {
					...
					if (schemas.size() > 0) {
						...
						System.out.println("ClientCommandEditor schema: "+  schema.toString());

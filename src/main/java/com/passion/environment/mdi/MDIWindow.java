...
import com.passion.common.gui.UWindow;
import com.passion.common.util.MacKeyBindings;
...
public class MDIWindow extends JFrame implements _Constants
{
    ...
    private void initActions()
    {
		...
		//this.getRootPane().getActionMap().put(ACTION_MDI_WRANGLE	, new MDIActions.Wrangle());
		this.getRootPane().getActionMap().put(ACTION_MDI_VISUALIZE	, new MDIActions.Visualize());
		...
		// ZigmaData will behave like a mac app (CMD+C for copy and other actions)

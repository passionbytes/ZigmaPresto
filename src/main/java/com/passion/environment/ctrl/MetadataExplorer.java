...
import com.passion.common.util.Classpath;
...
import com.passion.environment.ctrl.explorer.DialogExport;
import com.passion.environment.ctrl.explorer.SideNavigator;
import com.passion.environment.ctrl.explorer.SideSearchCriteria;
import com.passion.environment.ctrl.explorer.UoDatasource;
import com.passion.environment.ctrl.explorer.UoDriver;
import com.passion.environment.ctrl.explorer.UoLinks;
import com.passion.environment.mdi.ClientMetadataExplorer;
import com.passion.querybuilder.ViewObjects;
	...
	private void loadNavigator()
	{
		...
		if(Application.session.canMount(Application.ENTRY_JDBC))
		{
			...
			for(Enumeration eDv = Application.session.jumps(); eDv.hasMoreElements();)
			{
			    ...
			    System.out.println("uoDv.name: " + uoDv.name);
			   ...
			   System.out.println("uoDv.library: " +uoDv.library);
				try
				{
				...
				for(Enumeration eDs = Application.session.jumps(); eDs.hasMoreElements();)
				{
					...
					if(dsInfo.length >= 5){
						...
						System.out.println("dsInfo[4] == null ? null : dsInfo[4].toString();: " + uoDs.schema);

...
import com.passion.common.util.JdbcUtils;
import com.passion.common.util.SQLHelper;
import com.passion.environment.Application;
import com.passion.environment.ctrl.content.ContentModel;
import com.passion.environment.ctrl.content.ContentView;
import com.passion.environment.ctrl.content.TaskRetrieve;
import com.passion.environment.ctrl.content.TaskUpdate;
			...
			new Thread((new Runnable() {
				...
				public void run() {
					...
					try
					{
						...
						countQuery = SQLHelper.getZigmaDataFunctionQuery(countQuery,keycah);

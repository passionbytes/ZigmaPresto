...
package com.passion.environment.ctrl.content;
...
import com.passion.environment.mdi.DefaultMaskChooser;
...
public class DialogStream extends AbstractDialogWizard
{
	...
	{
		String tname = null;
		new DialogStream("Export-To-Excel", content.getView(), tname).setVisible(true);
	}
	...
	{
		if(this.getTitle().equals("Export-To-Excel"))
		{
			mkp = new MaskExport();

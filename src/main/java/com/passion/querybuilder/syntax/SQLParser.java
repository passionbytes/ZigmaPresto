...
public class SQLParser
{
		...
		throws IOException
	{
		...
		sql = sql.replaceAll("\\/\\*ZigmaData\\((\\w+)\\)\\*\\/","ZigmaData_$1");
		//System.out.println("SQLParser :::"+ sql);
...
*/
			...
			else if(next.toString().startsWith("ZigmaData_"))
			{
				if(dt!=null){
...
//		try
//		{
//			String fname = "E:/ZigmaData/tmp/test.sql";

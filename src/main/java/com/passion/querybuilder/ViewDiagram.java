...
import com.passion.querybuilder.dnd.EntityDropTargetListener;
...
public class ViewDiagram extends BorderLayoutPanel
{
	...
	void saveAsImage(String filename) throws IOException
	{
		...
		if (image != null)
		{
		     ...
		     graphics.drawString(_Version.PASSION_IMAGE_WATERMARK, (int)desktop.getWidth() * 0.8f , desktop.getHeight());
		     graphics.dispose();

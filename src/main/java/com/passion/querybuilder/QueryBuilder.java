...
import com.passion.environment.mdi.ClientQueryBuilder;
import com.passion.querybuilder.BrowserItems.DefaultTreeItem;
...
import com.passion.querybuilder.syntax.QueryTokens.Column;
import com.passion.querybuilder.syntax.QueryTokens.Condition;
import com.passion.querybuilder.syntax.QueryTokens.DefaultExpression;
import com.passion.querybuilder.syntax.QueryTokens._Expression;
	...
	public void stateChanged(ChangeEvent ce)
	{
		...
		if(this.getSelectedIndex() == 0)
		{
			...
			if(isSQLFile ){
				...
				//	System.out.println("QB  stateChanged " +cqb.getSchema() );
				...
				if(choice == JOptionPane.YES_OPTION)
				{
					...
					new Thread(new Runnable()
					{
						public void run()
						{
							...
							//	System.out.println("QB  stateChanged2 " +QueryBuilder.this.layout.getQueryModel().getSchema() );
